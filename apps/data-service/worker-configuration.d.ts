/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=dev --env-interface=BaseEnv` (hash: d48e382e7d6b367e5b4258e1477f666e)
// Runtime types generated with workerd@1.20260721.1 2026-07-08 nodejs_compat
interface __BaseEnv_BaseEnv {
	RATE_LIMIT_AUTH: RateLimit;
	RATE_LIMIT_HEALTH: RateLimit;
	CLOUDFLARE_ENV: "dev";
	ALLOWED_ORIGINS: "";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ENV" | "ALLOWED_ORIGINS" | "DATABASE_HOST" | "DATABASE_USERNAME" | "DATABASE_PASSWORD" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL">> {}
}
